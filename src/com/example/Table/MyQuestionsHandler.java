...
public class MyQuestionsHandler {
    ...
    public boolean iterate(){
        ...
        for(int i=0; i<QUESTIONS_COUNT; i++){
            if(AllQuestions.get(i).getCurrentCondition() != 4) {
                AllQuestions.get(i).setCurrentCondition(AllQuestions.get(i).getCurrentCondition() + 1);
                return true;
            }else{
                AllQuestions.get(i).setCurrentCondition(0);
            }
        }
    ...
    public MyQuestionsHandler() {
        for(int i=0; i<QUESTIONS_COUNT; i++)
        {
            AllQuestions.add(new MyQuestion(A));
        }
    }
}
